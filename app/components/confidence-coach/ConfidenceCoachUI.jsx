...
export function ConfidenceCoachUI() {
    ...
    return (
        <div className="w-full h-full flex gap-4 p-4 bg-background">
            ...
            <div className="w-[60%] bg-black rounded-2xl overflow-hidden relative shadow-2xl border border-border flex items-center justify-center">
                <video
                    ref={videoRef}
                    autoPlay
                    playsInline
            ...
            {/* Right Panel */}
            <div className="w-[40%] bg-card rounded-2xl border border-border p-6 flex flex-col shadow-xl overflow-y-auto">
                    ...
                    <div className="flex flex-col h-full justify-between">
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-4 mb-8">
                                <div>
                                    <label className="block text-xs font-bold uppercase tracking-wider text-muted-foreground mb-2">Scenario</label>
                                    <select
                                        value={scenarioCategory}
                                        onChange={(e) => setScenarioCategory(e.target.value)}
                                        className="w-full p-3 rounded-xl border border-input bg-background font-medium focus:ring-2 ring-primary/20 outline-none transition-all"
                                    >
                                        {scenarios.map(s => (
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="bg-secondary/20 p-5 rounded-2xl border border-border flex flex-col items-center text-center">
                                        ...
                                        <span className="text-2xl font-black text-primary mb-1">
                                            {Math.round(mlStats.faceFrames > 0 ? (mlStats.visibleFaceFrames / mlStats.faceFrames * 100) : 0)}%
                                        </span>
